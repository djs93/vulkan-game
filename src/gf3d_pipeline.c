...
void gf3d_pipeline_place_render_pass_setup(Pipeline* pipe)
{
	VkAttachmentDescription colorAttachment = { 0 };
	VkAttachmentReference colorAttachmentRef = { 0 };
	VkSubpassDescription subpass = { 0 };
...
Pipeline* gf3d_pipeline_basic_place_create(VkDevice device, char* vertFile, char* fragFile, VkExtent2D extent, Uint32 descriptorCount)
{
	Pipeline* pipe;
	VkRect2D scissor = { 0 };
	VkViewport viewport = { 0 };
	...
	gf3d_pipeline_place_render_pass_setup(pipe);
